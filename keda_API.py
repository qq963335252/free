...
# 调用动态链接库
dll = cdll.LoadLibrary("../Windows_aisound_exp1220_iat1220_tts_online1220_5c73560d/bin/msc_x64.dll")
# 登录参数，apppid一定要和你的下载SDK对应
login_params = b"appid = 5c73560d, work_dir = Windows_aisound_exp1220_iat1220_tts_online1220_5c73560d"
...
#path = "D:/chatbotv5/audio/input.wav"
#XF_text(path,16000)
